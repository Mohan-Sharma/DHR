...
public class DepartmentWiseStatisticsModel {
    ...
    @NotifyChange({ "maps" })
    public void search() {
	maps = patientAdmissionFinder.findDepartmentByDischargeDate(dischargeDate != null ? UtilDateTime.getDayStart(dischargeDate) : null,
