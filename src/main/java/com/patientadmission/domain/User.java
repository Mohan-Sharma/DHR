 ...
 */
@Entity
public class User extends IdGeneratingArcheType implements ICrudEntity {
    ...
    public static User createUserWithName(String firstName, String middleName, String lastName) {
    ...
    @JoinTable(name = "USER_ADMITTING_DEPARTMENT", joinColumns = {@JoinColumn(name = "USER_ID")}, inverseJoinColumns = {@JoinColumn(name = "ADMITTING_DEPARTMENT_ID")})
